...
always @(*) begin
    case (ram_ext_op)
        `RAM_EXT_HS: ext_out = {{16{real_din[15]}}, real_din[15:0]};
        `RAM_EXT_HU: ext_out = {16'h0000, real_din[15:0]};
        `RAM_EXT_BS: ext_out = {{24{real_din[7]}}, real_din[7:0]};
        `RAM_EXT_BU: ext_out = {24'h000000, real_din[7:0]};
